...
//import me.sid.smartcropper.models.OnSingleClickListener;
//
///**
...
//        thumbnailsViewHolder.thumbnail.setOnClickListener(new OnSingleClickListener() {
//            @Override
...
//            super(v);
//            this.thumbnail = (ImageView) v.findViewById(R.id.filter_iv);
//        }
//    }
//}