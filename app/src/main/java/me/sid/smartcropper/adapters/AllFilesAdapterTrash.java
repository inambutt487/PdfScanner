...
public class AllFilesAdapterTrash extends RecyclerView.Adapter<AllFilesAdapterTrash.MyFilesHolder> {
    ...
    public AllFilesAdapterTrash(Context context, ArrayList<FileInfoModel> filesArrayList,Activity activity) {
    ...
    public MyFilesHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.files_item_layout_trash, parent, false);
    ...
    void itemClick(MyFilesHolder holder){
        ...
        if (holder.fileTypeTv.getText().toString().equals("P")) {
            ...
            /*PdfViewerActivity.launchPdfFromPath(
                    context, filesArrayList.get(holder.getAdapterPosition()).getFile().getAbsolutePath(),
                    "Title", "dir",false, false
            );*/
