...
public class Constants {
    ...
    public static String textTranslate = null;
    ...
    public static String remoteStatus="Null";
    ...
    public static Uri fileUri(Context context, File file) {
        ...
        return FileProvider.getUriForFile(
                context, "com.pdfscanner.documentscanner.pdfmaster.fileProvider", new File(file.getAbsolutePath())
        );
    }
