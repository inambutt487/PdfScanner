...
public class ColorPickerAdapter extends RecyclerView.Adapter<ColorPickerAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        shape.setColor(colorPickerColors.get(position));

        holder.colorPickerView.setBackground(shape);
    }
    ...
    public static List<Integer> getDefaultColors(Context context) {
        ...
        colorPickerColors.add(ContextCompat.getColor(context, R.color.color1));
        colorPickerColors.add(ContextCompat.getColor(context, R.color.color2));
        colorPickerColors.add(ContextCompat.getColor(context, R.color.color3));
