...
public class AllFilesInFolderActivity extends BaseActivity implements View.OnClickListener,AllFilesAdapter.AdapterInterface{
    File folderFile;
    Toolbar toolbar;
...
//        importFilesBtn.setOnClickListener(this);
        ...
        adapter = new AllFilesAdapter(AllFilesInFolderActivity.this, fileInfoModelArrayList,AllFilesInFolderActivity.this,AllFilesInFolderActivity.this, false);
        ...
        if (requestCode == mFileSelectCode && data != null) {
            ...
            if (isMoved) {
                if (adapter.getRealArray().size() == 0) {
                    ...
                    adapter = new AllFilesAdapter(this, fileInfoModelArrayList,AllFilesInFolderActivity.this,AllFilesInFolderActivity.this, false);
