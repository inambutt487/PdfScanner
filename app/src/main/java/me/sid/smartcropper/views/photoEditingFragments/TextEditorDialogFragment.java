package me.sid.smartcropper.views.photoEditingFragments;
...
public class TextEditorDialogFragment extends DialogFragment {
    ...
    private Button btnDone,btnCancel, btn_clear_text;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        btnDone = view.findViewById(R.id.btn_done_text);
        btnCancel = view.findViewById(R.id.btn_cancel_text);
        ...
        mColorCode = getContext().getColor(R.color.black);
